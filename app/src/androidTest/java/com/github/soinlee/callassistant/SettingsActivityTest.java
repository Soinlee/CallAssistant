...
import static com.github.soinlee.callassistant.TestUtils.atPosition;
import static com.github.soinlee.callassistant.TestUtils.checkRadioItem;
import static com.github.soinlee.callassistant.TestUtils.childWithBackgroundColor;
import static com.github.soinlee.callassistant.TestUtils.isWindowAtPosition;
import static com.github.soinlee.callassistant.TestUtils.setProgress;
import static com.github.soinlee.callassistant.TestUtils.swipeDown;
import static com.github.soinlee.callassistant.TestUtils.swipeUp;
import static com.github.soinlee.callassistant.TestUtils.withHeight;
import static com.github.soinlee.callassistant.TestUtils.withTextAlign;
import static com.github.soinlee.callassistant.TestUtils.withTextPadding;
import static com.github.soinlee.callassistant.TestUtils.withTextSize;
import static com.github.soinlee.callassistant.TestUtils.withTransparency;
...
public class SettingsActivityTest extends ActivityTestBase {
    ...
    CallMonitorView mCallMonitorView;

    @Override
    public void beforeTest() {
        navigateToSetting();
        mCallMonitorView = new CallMonitorView(getTargetContext());
    }
    ...
    public void testWindowOutgoingVisibilitySetting() {
        ...
        mCallMonitorView.onCallStateChanged(TelephonyManager.CALL_STATE_OFFHOOK, "10086");
        ...
        mCallMonitorView.onCallStateChanged(TelephonyManager.CALL_STATE_IDLE, "10086");
    }
    ...
    public void testWindowHideAfterAcceptSetting() {
        ...
        mCallMonitorView.onCallStateChanged(TelephonyManager.CALL_STATE_RINGING, "10086");
        onView(withId(R.id.window_layout)).inRoot(not(isDialog()))
                .check(matches(isDisplayed()));
        onView(withId(R.id.number_info)).inRoot(not(isDialog()))
                .check(matches(withText("中国移动客服")));
