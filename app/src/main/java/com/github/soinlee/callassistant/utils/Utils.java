...
public final class Utils {
    ...
    public static String getDeviceId(Context context) {
        ...
        // ANDROID_ID is stable per (app-signing-key, user, device) combination and
        // does not require any dangerous/privileged permission. Using it alone avoids
        // deprecated TelephonyManager#getDeviceId/getSimSerialNumber which need
        // READ_PRIVILEGED_PHONE_STATE on Android 10+ and throw SecurityException.
        return new UUID(androidId.hashCode(), androidId.hashCode() * 31L).toString();
    }
    ...
    public static String sourceFromId(int sourceId) {
        ...
        if (sNumberSourceMap == null) {
            ...
            // keys 与 values 必须一一对应，两者长度不同会越界（见 arrays.xml 注释）。
